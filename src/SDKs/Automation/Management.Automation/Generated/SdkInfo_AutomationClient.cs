      ...
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_AutomationClient
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("Automation", "Runbook", "2018-06-30-Pre1"),
                new Tuple<string, string, string>("Automation", "RunbookDraft", "2018-06-30-Pre1"),
                ...
                new Tuple<string, string, string>("Automation", "TestJob", "2018-06-30-Pre1"),
                new Tuple<string, string, string>("Automation", "TestJobStreams", "2018-06-30-Pre1"),
